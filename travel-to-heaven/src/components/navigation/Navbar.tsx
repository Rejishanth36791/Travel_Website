...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 dark:bg-[#0c1e28]/80 backdrop-blur-xl border-b border-slate-200/40 dark:border-white/10 shadow-xs transition-all">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-2">
                ...
                {/* Instagram Create Post Button */}
                <Link to="/community?create=true">
                  <button className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-linear-to-tr from-amber-500 via-rose-500 to-fuchsia-600 hover:opacity-95 text-white font-bold text-xs shadow-sm transition-all hover:scale-105 active:scale-95 cursor-pointer">
